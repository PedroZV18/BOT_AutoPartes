...
• Descuentos por fidelidad''',
            ...
            'frenos': [
                {
                    ...
                    'marca': 'Bosch',
                    'modelo_compatible': ['Toyota Corolla 2015-2020', 'Honda Civic 2016-2021'],
                    'precio': 180.00,
                    'stock': 15,
                    'descripcion': 'Pastillas de freno cerámicas de alto rendimiento, baja emisión de polvo y mayor durabilidad',
                    'garantia': '12 meses',
                    'categoria': 'Frenos',
                    'numero_serie': 'BOS-0987-FR'
                },
                {
                    'id': 'FR-002',
                    'nombre': 'Disco de Freno Delantero Ventilado',
                    'marca': 'Brembo',
                    'modelo_compatible': ['Nissan Sentra 2014-2019', 'Hyundai Elantra 2015-2020'],
                    'precio': 320.00,
                    'stock': 8,
                    'descripcion': 'Disco de freno ventilado para mejor disipación de calor, performance deportivo',
                    'garantia': '18 meses',
                    'categoria': 'Frenos',
                    'numero_serie': 'BRE-1234-FD'
                },
                {
                    'id': 'FR-003',
                    'nombre': 'Kit de Pastillas Traseras',
                    'marca': 'ACDelco',
                    'modelo_compatible': ['Chevrolet Aveo 2012-2018', 'Suzuki Swift 2010-2017'],
                    'precio': 150.00,
                    'stock': 12,
                    'descripcion': 'Kit completo pastillas traseras, incluye sensores de desgaste',
                    'garantia': '12 meses',
                    'categoria': 'Frenos',
                    'numero_serie': 'ACD-5678-RT'
                }
            ],
            'motor': [
                {
                    ...
                    'marca': 'Mann-Filter',
                    'modelo_compatible': ['VW Golf 2015-2020', 'Audi A3 2014-2019'],
                    'precio': 45.00,
                    'stock': 25,
                    'descripcion': 'Filtro de aceite de alta eficiencia para aceites sintéticos',
                    'garantia': '6 meses',
                    'categoria': 'Motor',
                    'numero_serie': 'MAN-9012-OF'
                },
                {
                    'id': 'MO-002',
                    'nombre': 'Kit de Correa de Distribución',
                    'marca': 'Gates',
                    'modelo_compatible': ['Toyota Hilux 2015-2021', 'Ford Ranger 2016-2022'],
                    'precio': 420.00,
                    'stock': 6,
                    'descripcion': 'Kit completo: correa, tensores y poleas. Calidad premium',
                    'garantia': '24 meses',
                    'categoria': 'Motor',
                    'numero_serie': 'GAT-3456-TK'
                },
                {
                    'id': 'MO-003',
                    'nombre': 'Bujías de Iridio',
                    'marca': 'NGK',
                    'modelo_compatible': ['BMW Serie 3 2012-2019', 'Mercedes-Benz Clase C 2013-2018'],
                    'precio': 280.00,
                    'stock': 18,
                    'descripcion': 'Bujías de iridio para mejor combustión y ahorro de combustible',
                    'garantia': '12 meses',
                    'categoria': 'Motor',
                    'numero_serie': 'NGK-7890-SP'
                }
            ],
            'suspension': [
                {
                    ...
                    'marca': 'KYB',
                    'modelo_compatible': ['Kia Rio 2011-2017', 'Hyundai Accent 2010-2017'],
                    'precio': 380.00,
                    'stock': 10,
                    'descripcion': 'Amortiguador a gas, comfort superior y durabilidad extendida',
                    'garantia': '18 meses',
                    'categoria': 'Suspensión',
                    'numero_serie': 'KYB-1122-SF'
                },
                {
                    'id': 'SU-002',
                    'nombre': 'Kit de Rotulas y Terminales',
                    'marca': 'TRW',
                    'modelo_compatible': ['Nissan Tiida 2007-2014', 'Renault Logan 2009-2015'],
                    'precio': 220.00,
                    'stock': 14,
                    'descripcion': 'Kit completo dirección, incluye rotulas y terminales',
                    'garantia': '12 meses',
                    'categoria': 'Suspensión',
                    'numero_serie': 'TRW-3344-ST'
                }
            ],
            'electrico': [
                {
                    ...
                    'marca': 'ACDelco',
                    'modelo_compatible': ['Toyota Yaris 2014-2020', 'Honda Fit 2013-2020'],
                    'precio': 480.00,
                    'stock': 9,
                    'descripcion': 'Batería libre de mantenimiento, alta capacidad de arranque',
                    'garantia': '24 meses',
                    'categoria': 'Eléctrico',
                    'numero_serie': 'ACD-5566-BT'
                },
                {
                    'id': 'EL-002',
                    'nombre': 'Alternador 12V 90A',
                    'marca': 'Denso',
                    'modelo_compatible': ['Mitsubishi L200 2015-2021', 'Nissan NP300 2014-2020'],
                    'precio': 850.00,
                    'stock': 4,
                    'descripcion': 'Alternador reconstruido con garantía, incluye instalación',
                    'garantia': '12 meses',
                    'categoria': 'Eléctrico',
                    'numero_serie': 'DEN-7788-AL'
                }
            ],
            'aceites': [
                {
                    ...
                    'marca': 'Mobil',
                    'modelo_compatible': ['Vehículos a gasolina 2010-2023'],
                    'precio': 180.00,
                    'stock': 30,
                    'descripcion': 'Aceite sintético full, protección superior del motor',
                    'garantia': 'N/A',
                    'categoria': 'Lubricantes',
                    'numero_serie': 'MOB-9900-SY'
                },
                {
                    'id': 'AC-002',
                    'nombre': 'Aceite Mineral 20W-50',
                    'marca': 'Repsol',
                    'modelo_compatible': ['Vehículos antiguos y motos'],
                    'precio': 95.00,
                    'stock': 22,
                    'descripcion': 'Aceite mineral para motores de alto kilometraje',
                    'garantia': 'N/A',
                    'categoria': 'Lubricantes',
                    'numero_serie': 'REP-8811-MN'
                }
            ]
        }
    ...
    def buscar_productos(self, categoria=None, marca=None, modelo=None):
        """Busca productos en el catálogo según los criterios"""
        resultados = []
        
        for cat, productos in self.catalogo.items():
            for producto in productos:
                if categoria and categoria.lower() not in cat.lower():
                    continue
                if marca and marca.lower() not in producto['marca'].lower():
                    continue
                if modelo:
                    modelo_encontrado = False
                    for modelo_comp in producto['modelo_compatible']:
                        if modelo.lower() in modelo_comp.lower():
...
• Pago contra entrega''',
        ...
        # Búsqueda por categoría
            ...
            productos = self.buscar_productos(categoria='aceites')
            return {
        ...
        # Búsqueda por marca
            ...
            if marca:
                productos = self.buscar_productos(marca=marca)
                return {
        ...
        # Horario de atención
        elif any(palabra in pregunta for palabra in ['horario', 'hora', 'atención', 'abren', 'cierra', 'atien', 'cuándo', 'cuando', 'disponible']):
    ...
    <head>
        ...
        <style>
            ...
            * {
            ...
            /* LOGO MEJORADO - COLORES QUE COMBINAN CON EL BOT */
            .logo-icon {
                width: 50px;
                height: 50px;
        ...
        <div class="app-container">
            <div class="sidebar">
                ...
                <div class="quick-actions">
                    <div class="section-title">Catálogo en Tabla</div>
                    <button class="quick-action" onclick="hacerPregunta('Ver catálogo completo')">
                        <div class="quick-action-icon">📊</div>
                        Catálogo completo
                    </button>
                    <button class="quick-action" onclick="hacerPregunta('Sistema de frenos')">
                        <div class="quick-action-icon">🛑</div>
                        Frenos en tabla
                    </button>
                    <button class="quick-action" onclick="hacerPregunta('Motor')">
                        <div class="quick-action-icon">🔧</div>
                        Motor en tabla
                    </button>
                    <button class="quick-action" onclick="hacerPregunta('Suspensión')">
                        <div class="quick-action-icon">🔄</div>
                        Suspensión en tabla
                    </button>
                    
                    <div class="section-title" style="margin-top: 25px;">Búsquedas por Marca</div>
                    <button class="quick-action" onclick="hacerPregunta('Productos Bosch')">
                        <div class="quick-action-icon">🏷️</div>
                        Productos Bosch
                    </button>
                    <button class="quick-action" onclick="hacerPregunta('Productos ACDelco')">
                        <div class="quick-action-icon">🏷️</div>
                        Productos ACDelco
                    </button>
                    <button class="quick-action" onclick="hacerPregunta('Productos NGK')">
                        <div class="quick-action-icon">🏷️</div>
                        Productos NGK
                    </button>
                    
                    <div class="section-title" style="margin-top: 25px;">Información General</div>
                    <button class="quick-action" onclick="hacerPregunta('¿Cuál es su horario de atención?')">
                        <div class="quick-action-icon">🕒</div>
                        Horarios de atención
                    </button>
                    <button class="quick-action" onclick="hacerPregunta('¿Dónde se ubican?')">
                        <div class="quick-action-icon">📍</div>
                        Ubicación y sucursales
                    </button>
                    <button class="quick-action" onclick="hacerPregunta('Necesito una cotización')">
                        <div class="quick-action-icon">💰</div>
                        Solicitar cotización
                    </button>
                    <button class="quick-action" onclick="hacerPregunta('Métodos de pago')">
                        <div class="quick-action-icon">💳</div>
                        Métodos de pago
                    </button>
                </div>
...
**¿Qué te gustaría consultar?**
                ...
                <div class="modal-body">
                    <form id="pagoForm">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-input" placeholder="Ingrese su país" required>
                        </div>
                        
                        <div class="form-group">
                            <label class="form-label">Departamento/Provincia</label>
                            <input type="text" class="form-input" placeholder="Ingrese su departamento o provincia" required>
                        </div>
                        
                        <div class="form-group">
                            <label class="form-label">Distrito</label>
                            <input type="text" class="form-input" placeholder="Ingrese su distrito" required>
                        </div>
        ...
        <script>
            ...
            document.getElementById('pagoForm').addEventListener('submit', function(e) {
                e.preventDefault();
                alert('¡Pago procesado exitosamente! Recibirás una confirmación por correo electrónico.');
                cerrarModalPago();
            });
            ...
            // Hacer pregunta desde botones - FUNCIÓN CORREGIDA
...
if __name__ == '__main__':
    ...
    print("🎨 Logo con colores que combinan con la estética del bot")
    print("🔧 Botones corregidos y funcionando correctamente")
    print("📊 Catálogo en formato tabla con 15 productos organizados")
    print("💳 Métodos de pago integrados: Yape, Plin y Transferencia")
    print("💰 Botones de Realizar Pago y Separar Pieza añadidos")
